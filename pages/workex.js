const WorkEx = () => {
  const events = [
    ...
    { date: "Mar 2019", company: "Charles River Development",title: "Event 2", content: "Details of event 2..." },
    { date: "Feb 2021", company: "Charles River Development", title: "Event 3", content: "Details of event 3..." },
    // ... more events
  ];
      ...
      <div className="relative w-full">
        ...
        {events.map((event, index) => (
          <div key={index} className="flex items-center my-4 w-full relative ">
            ...
            <div className=" text-center px-2 dark:text-slate-400 text-gray-600">{event.title}</div>
            <div className=" px-2 dark:text-slate-400 text-gray-600">{event.company}</div>
</div>  
            {/* Date on the Line */}
            <div className=" h-8 px-2 flex items-center justify-center ml-4 bg-teal-300 border border-gray-400 shadow-2xl shadow-black
            ...
            <div className=" px-2 dark:text-slate-400 text-gray-600 ">{event.content}</div>
            </div>
